...
contextBridge.exposeInMainWorld('trim', {
  ...
  doAnswer: (answer) => ipcRenderer.send('trim:do-answer', answer),
  onDoStatus: (cb) => ipcRenderer.on('trim:do-status', (_e, data) => cb(data)),
  offDoStatus: () => ipcRenderer.removeAllListeners('trim:do-status'),
  onDoAskUser: (cb) => ipcRenderer.on('trim:do-ask-user', (_e, data) => cb(data)),
  offDoAskUser: () => ipcRenderer.removeAllListeners('trim:do-ask-user'),
